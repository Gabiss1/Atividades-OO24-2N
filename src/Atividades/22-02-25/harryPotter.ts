...
export class Pocao{
    ...
    setAtributos(nome:string, ingredientes:Array<object>, efeito:string):void{
        this.nome = nome
    ...
    exibirPocao():void{
        let ing1 = this.ingredientes
        console.log(`A Poção do morto vivo
Efeito: ${this.efeito}.
Ingredientes: 
...
pocao1.setAtributos('Poção do Morto-Vivo', [ingrediente1, ingrediente2], 'Faz a pessoa entrar em um sono profundo similar a morte.')
